...
class ArtistScreen extends StatefulWidget {
  const ArtistScreen({super.key, required this.playlistModel});
  final ArtistModel playlistModel;
...
class _ArtistScreenState extends State<ArtistScreen> {
  ...
  late ArtistModel model = widget.playlistModel;

  @override
  void initState() {
    BlocProvider.of<ArtistCubit>(context)
        .getArtistInfo(widget.playlistModel);
    super.initState();
  }
